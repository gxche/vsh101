...
本專案的 BLE 通訊協定基於 `VSH101-ECG-IMU-Full/VSH101-ECG-IMU-Full.ino`，該 Arduino 程式實作了 ESP32 作為 BLE client 連線至 VSH101 裝置的完整邏輯。Web 版本將相同的協定移植至瀏覽器端的 Web Bluetooth API。
